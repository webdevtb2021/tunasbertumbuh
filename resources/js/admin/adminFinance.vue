                        ...
                        <div class="card-tools ml-auto ">
                            <div class="input-group input-group-sm">
                                ...
                                <button type="submit" class="btn btn-success" data-toggle="modal"
                                    data-target="#exampleModal" @click.prevent="showModal"><i
                                        class="fas fa-calendar-plus"></i> Add new data</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 v-show="isFormCreateMode" class="modal-title" id="exampleModalLabel">Add new data
                                    keuangan</h5>
                                <h5 v-show="!isFormCreateMode" class="modal-title" id="exampleModalLabel">Update data
                                    keuangan</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.date" type="text" name="date" class="form-control"
                                            placeholder="dd-mm-yyyy" aria-label="tanggal"
                                            aria-describedby="basic-addon1" />
                                    </div>
                                    <div class="form-group">
                                        <label>Keterangan</label>
                                        <textarea v-model="form.notes" type="text" name="notes" class="form-control"
